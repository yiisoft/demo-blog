    ...
    <div class="hero-section text-center py-5">
        ...
        <div class="mt-5">
            ...
            <div class="list-group mx-auto" style="max-width: 600px;">
                <a href="/api/blog/category/list" class="list-group-item list-group-item-action" target="_blank" rel="noopener noreferrer">
                    <div class="d-flex w-100 justify-content-between">
                        <h6 class="mb-1"><i class="bi bi-folder me-2"></i>Category List</h6>
                        <small class="text-muted">GET</small>
                    </div>
                    <small class="text-muted">/api/blog/category/list</small>
                </a>
                <a href="/api/blog/post/list" class="list-group-item list-group-item-action" target="_blank" rel="noopener noreferrer">
                    <div class="d-flex w-100 justify-content-between">
                        <h6 class="mb-1"><i class="bi bi-file-text me-2"></i>Post List</h6>
                        <small class="text-muted">GET</small>
                    </div>
                    <small class="text-muted">/api/blog/post/list</small>
                </a>
            </div>
        </div>
    </div>
