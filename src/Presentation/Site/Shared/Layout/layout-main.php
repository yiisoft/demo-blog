...
use App\Presentation\Site\Shared\Layout\Breadcrumbs\Breadcrumbs;
use App\Presentation\Site\Shared\Layout\ContentNotices\ContentNoticesWidget;
use App\Presentation\Site\Shared\Layout\MainAsset;
use App\Presentation\Site\Shared\Layout\Menu\Item;
use App\Presentation\Site\Shared\Layout\Menu\MainMenu;
...
<div class="container">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 mt-4 border-top">
        <div class="col-md-4 d-flex align-items-center">
            <span class="mb-3 mb-md-0 text-body-secondary">Yii3 Demo Blog</span>
        </div>
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex fs-3">
            <li class="ms-3">
                <a class="link-secondary" href="https://github.com/yiisoft/demo-blog" title="GitHub">
